import { HealthState, PlanTier } from '../types';
import { SIZE_LADDER, planPosition, rampIndex, sampleRamp } from '../lib/plans';
import { CanvasTokens, ChromeTokens, ResolvedMode } from '../lib/theme';
import { PlantSpec, metricCanopyColors } from './metricPlantSprite';
