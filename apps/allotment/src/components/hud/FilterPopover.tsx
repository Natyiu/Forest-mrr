...
export const FilterPopover: React.FC<FilterPopoverProps> = ({
  ...
  return (
  <Popover open={open} onClose={onClose} className="right-0 top-12 w-[320px]">
    <div className="relative">
      ...
      <input
        ...
        className="w-full rounded-xl border border-hairline bg-inset py-2.5 pl-9 pr-3 text-[13px] text-ink outline-none placeholder:text-ink-faint focus:border-accent-line focus:bg-surface-solid"
      />
    </div>
