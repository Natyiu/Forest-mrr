 ...
 *            `text-ink`, `bg-accent` utilities, so no component knows a colour.
...
const CHROME_SEASON: Record<Season, Record<ResolvedMode, AccentSet>> = {
  ...
  summer: {
    light: {
      pageFrom: '#FAFBF6', pageVia: '#F4F7EF', pageTo: '#EAF0E3',
  ...
  autumn: {
    light: {
      pageFrom: '#FCF7EE', pageVia: '#F7F0E3', pageTo: '#EFE5D3',
  ...
  winter: {
    light: {
      pageFrom: '#F7FAFC', pageVia: '#EFF4F8', pageTo: '#E3ECF3',
