...
export const ChartTooltip: React.FC<{
  ...
  return (
    <div
      className="pointer-events-none absolute z-20 min-w-[132px] rounded-2xl border border-hairline bg-surface-solid px-2.5 py-2 shadow-panel"
      style={{
        left: x,
        top: y,
...
export const TableToggle: React.FC<{
  ...
  <details className="group mt-3">
    ...
    <div className="mt-2 max-h-52 overflow-auto rounded-2xl border border-hairline">
