...
import { type GardenState, type Plant } from '../types';
      ...
      <div className="relative w-full max-w-5xl bg-slate-900 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.5)] border border-slate-800 p-6 text-slate-100 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-800 shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-[20px] bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-2xl text-xs font-bold transition-all cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 ${
                orbiting
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold transition-all cursor-pointer border border-slate-700"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-4 flex-1 overflow-hidden">
          {/* Globe Canvas Column */}
          <div className="lg:col-span-7 flex flex-col items-center justify-center bg-slate-950/80 rounded-[20px] border border-slate-800/80 p-4 relative min-h-[360px] overflow-hidden">
            {viewMode === '3d_globe' ? (
              <Globe
                config={globeConfig}
                autoRotate={orbiting}
            ...
            <div className="absolute bottom-3 left-3 bg-slate-900/90 backdrop-blur-md px-3 py-1.5 rounded-2xl border border-slate-800 text-[11px] font-bold text-slate-300 flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {regionStats.map((reg) => (
                  <button
                    ...
                    className={`p-2.5 rounded-2xl border text-left transition-all cursor-pointer flex flex-col ${
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {onSelectPlantFromGlobe && c.plants.length > 0 && (
                          <button
                            ...
                            className="p-1 rounded-xl bg-slate-700/60 hover:bg-slate-700 text-slate-300 hover:text-white"
